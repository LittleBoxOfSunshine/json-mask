...
impl<'a, S> MaskedSerializer<'a, S> {
    pub fn new(serializer: &'a mut S, mask: Mask) -> Self {
    ...
    &'a mut S: Serializer,
{
    ...
    type SerializeStruct =
        MaskedSerializeStructWrapper<'a, <&'a mut S as Serializer>::SerializeStruct>;
    ...
    fn serialize_map(self, len: Option<usize>) -> Result<Self::SerializeMap, Self::Error> {
        ...
        Ok(MaskedSerializeMapWrapper {
            map_serializer: underlying_serializer,
            mask: &self.mask,
        })
    }
    ...
    fn serialize_struct(
        ...
        Ok(MaskedSerializeStructWrapper {
            struct_serializer: underlying_serializer,
            mask: &self.mask,
        })
    }
